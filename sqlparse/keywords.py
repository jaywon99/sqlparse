...
SQL_REGEX = {
    'root': [
        ...
        # in mysql, no need space after '#', but '--' need space
        (r'(-- |#)\+.*?(\r\n|\r|\n|$)', tokens.Comment.Single.Hint),
