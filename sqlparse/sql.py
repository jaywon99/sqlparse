...
class Between(TokenList):
    """A between comparison used for example in WHERE clauses."""
...
class On(TokenList):
    ...
    M_CLOSE = T.Keyword, (
        'ORDER BY', 'GROUP BY', 'LIMIT', 'UNION', 'UNION ALL', 'EXCEPT',
        'HAVING', 'RETURNING', 'INTO', 'WHERE', 'LEFT INNER JOIN',
        'LEFT OUTER JOIN', 'LEFT STRAIGHT JOIN', 'LEFT JOIN',
        'RIGHT INNER JOIN', 'RIGHT OUTER JOIN', 'RIGHT STRAIGHT JOIN',
        'RIGHT JOIN', 'FULL INNER JOIN', 'FULL OUTER JOIN',
        'FULL STRAIGHT JOIN', 'FULL JOIN', 'INNER JOIN', 'OUTER JOIN',
        'STRAIGHT JOIN', 'CROSS JOIN', 'NATURAL JOIN', 'JOIN')
